...
${TESTDIR}/test_tantque.o: test_tantque.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/test_tantque.o test_tantque.cpp


${TESTDIR}/test_tantque_runner.o: test_tantque_runner.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/test_tantque_runner.o test_tantque_runner.cpp
