...
# Test Object Files
TESTOBJECTFILES= \
	${TESTDIR}/test_tantque.o \
	${TESTDIR}/test_tantque_runner.o
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/test_tantque.o ${TESTDIR}/test_tantque_runner.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS}   `cppunit-config --libs`   


${TESTDIR}/test_tantque.o: test_tantque.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/test_tantque.o test_tantque.cpp


${TESTDIR}/test_tantque_runner.o: test_tantque_runner.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/test_tantque_runner.o test_tantque_runner.cpp
